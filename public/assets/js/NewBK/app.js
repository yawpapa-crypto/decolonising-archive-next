...
window.addEventListener("pageshow", restoreArchiveView);
window.addEventListener("popstate", restoreArchiveView);
window.addEventListener("focus", restoreArchiveView);
