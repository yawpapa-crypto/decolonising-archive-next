  ...
  return (
    ...
    >
      ...
      {notes.length ? (
        <div
          ref={notesLayoutRef}
          className="workbench-notes-layout-premium workbench-notes-layout"
          style={notesLayoutStyle}
        >
          <div className="workbench-notes-list-panel workbench-notes-list" aria-label="Notes list">
            <input
              type="search"
          ...
          <div
            className="workbench-notes-resizer"
            role="separator"
            ...
            {selectedNote ? (
              isEditorialReading ? (
                <div className="workbench-editorial-workspace">
                  ...
                  <div className="workbench-editorial-main">
