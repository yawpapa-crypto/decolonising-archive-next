    ...
    >
      {notes.length ? (
        <>
          <button
            type="button"
            className="workbench-floating-notes-toggle"
            onClick={() => setNotesDrawerOpen((open) => !open)}
            aria-expanded={notesDrawerOpen}
            aria-controls="workbench-notes-drawer"
          >
          ...
          {notesDrawerOpen ? (
            <button
              type="button"
              className="workbench-notes-drawer-backdrop"
          ...
          <aside
            id="workbench-notes-drawer"
            className={`workbench-notes-drawer${notesDrawerOpen ? " is-open" : ""}`}
            aria-label="Notes list"
          >
            <div className="workbench-notes-drawer__header">
              <strong>Notes</strong>
              <button
                type="button"
                className="workbench-notes-drawer__close"
                onClick={() => setNotesDrawerOpen(false)}
                aria-label="Close notes drawer"
              >
                Close
            ...
            <div className="workbench-notes-drawer__body workbench-notes-list">
              <input
                type="search"
      ...
      <header className="workbench-notes-header workbench-notes-header--fixed workbench-notes-page-header">
        <div className="workbench-notes-page-header__top">
          ...
          <div className="workbench-notes-header-actions">
            ...
            {selectedNote ? (
              <div className="workbench-note-mode-switcher" role="tablist" aria-label="Note mode">
                {NOTE_MODES.map((mode) => (
                  <button
                    key={mode.id}
                    type="button"
              ...
              isEditorialReading ? (
                <div className="workbench-editorial-workspace">
                  ...
                  >
                    ...
                    {inspectorOpen ? (
                      <aside className="workbench-inspector-shell" aria-label="Research Inspector">
                        <div className="workbench-inspector-shell__topbar">
                          <span className="workbench-inspector-shell__title">Research Inspector</span>
                          <button
                            type="button"
                            className="workbench-inspector-shell__close"
                      ...
                      <button
                        type="button"
                        className="workbench-floating-inspector-toggle"
