            ...
            readingLists.map((list) => {
              ...
              return (
                <article
                  ...
                  data-group-type={list.group_type ?? "theme"}
                ...
                >
                    ...
                    <div>
                      ...
                      <div className="workspace-reading-list-meta">
                        ...
                        <span className="member-dashboard-pill">
                          {list.group_label ||
                            (list.group_type === "project"
                              ? "Project"
                              : list.group_type === "source_type"
                                ? "Source type"
                                : list.group_type === "media_type"
                                  ? "Media type"
                                  : list.group_type === "course_research_paper"
                  ...
                  <form action={updateReadingList} className="workspace-form workspace-form-compact">
                    ...
                    <label>
                      <span>Group by</span>
                      <select name="group_type" defaultValue={list.group_type ?? "theme"}>
                    ...
                    <label>
                      ...
                      <input
                        name="group_label"
                        defaultValue={list.group_label ?? ""}
                        placeholder="e.g. Week 4 seminar, oral histories"
                      />
                    </label>
